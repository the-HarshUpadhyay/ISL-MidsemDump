...
================================================================================
QUESTION 2 — HASH-BASED NETWORK DATA INTEGRITY (SERVER)
...
This file implements the SERVER portion of the question.
"""
...
with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as server_socket:
    ...
    with connection:
        ...
        received_hash = user_defined_hash(message)

        print("Received message:", message)
        print("Computed hash:", received_hash)

        connection.sendall(str(received_hash).encode("utf-8"))
